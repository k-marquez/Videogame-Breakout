    ...
    def update(self, dt: float) -> None:
        ...
        for ball in self.balls:
            ...
            if random.random() < 0.75:
                ...
                elif random.random() < 0.8 and not self.find_activated_powerups(list_names) and not self.find_activated_powerups("CannonBall2"):
                    self.powerups.append(
                ...
                # Chance to generate a pair of cannons
                elif random.random() < 0.02 and not self.find_activated_powerups(list_names) and not self.find_activated_powerups("CannonBall1"):
                    self.powerups.append(
